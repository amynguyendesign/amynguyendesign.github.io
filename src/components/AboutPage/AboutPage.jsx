    ...
    <div className="homeContainer aboutContainer fadeSlideIn">
      ...
      <div className="leftText">
        ...
        <p>
          ...
          UI interaction, or a spacing that’s off by 2px and now I can’t unsee
          it. I’m drawn to patterns — not just visual ones, but conceptual ones.
          I have a gut feeling for how things align, when they work, and where
          they break. I have a deep love for aesthetics and for the quiet magic
          of things crafted with intention.
        </p>
